...
- While we run a program, it needs some services that the language provides like [garbage collector](<https://en.wikipedia.org/wiki/Garbage_collection_(computer_science)>), [automatic memory management](https://en.wikipedia.org/wiki/Memory_management), [exception handling](https://en.wikipedia.org/wiki/Exception_handling), etc.
...
That's all there is to it and i hope i made some sense and you got to know how an compiler/interpreter works, It was simplified alot from the book :P
